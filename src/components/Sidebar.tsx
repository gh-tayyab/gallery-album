    ...
    return (
        <div className='pb-12 border-r h-full border-neutral-700'>
         <div className="md:hidden">
                <Sheet>
                    <SheetTrigger><IoMdMenu size={30} className="mt-6 ml-5" /></SheetTrigger>
                    <SheetContent>
                        <SheetHeader>
            ...
            <div className='hidden md:block space-y-4 py-4' >
                ...
                <div className=' hidden md:block px-3 py-2'>
                    ...
                    <div className='space-y-1'>
                        ...
                        <Link href={"/Album"}>
                            <Button variant='ghost' className="w-full justify-start text-lg hover:bg-neutral-700  ">
                               <FiFolderMinus className="w-5 h-6 mr-3 " />
                                 Photo Album
                            </Button></Link>
                        {/* button3 */}
                        <Link href={"/favourite"}>
                            <Button variant='ghost' className="w-full justify-start text-lg hover:bg-neutral-700  ">
                            <IoHeartOutline className="w-6 h-6 mr-3" />
                                Favourites
                            </Button></Link>
                    </div>
                    </div>
